	...
	<view class="after_sales">
		...
		<view class="after_s">
			<view class="after_s_r">
				<view class="titel">退款信息</view>
			<!--<u-cell-item title="货物状态" :value="thegoods" index="1" @click="oncellclick"></u-cell-item>
				<u-cell-item title="退款原因" value="请选择" index="2" @click="oncellclick"></u-cell-item> -->
				<u-cell-item title="退款金额" :value="obj.total_price" :arrow="false" :value-style="{'color':'#FF0000'}">
				</u-cell-item>
			</view>
		</view>
		<view class="after_s">
			<view class="after_s_r">
				...
				<u-field v-model="desc" label-width="0" :field-style="{'height':'160rpx'}" placeholder="请简单说明退款原因.....">
				</u-field>
			</view>
		</view>
		...
		<u-popup v-model="show2" mode="bottom" border-radius="20" length="55%" :closeable="true">
			<view class="csspopup">
				<view class="titel" style="text-align: center;">退款原因</view>
				<u-cell-item title="不想要/不喜欢" :arrow="false"></u-cell-item>
				<u-cell-item title="空包裹" :arrow="false"></u-cell-item>
				<u-cell-item title="货物破损已拒签" :arrow="false"></u-cell-item>
				<u-cell-item title="快递/物流无跟踪记录" :arrow="false"></u-cell-item>
				<u-cell-item title="大小/重量商品描述不符合" :arrow="false"></u-cell-item>
				<u-cell-item title="质量问题" :arrow="false"></u-cell-item>
				<u-cell-item title="其他" :arrow="false"></u-cell-item>
				<view class="fedback_top">
					<view class="fedbackg_btn" >
						确定
					</view>
